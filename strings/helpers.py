...
ᴛʜᴇsᴇ ᴀʀᴇ ᴛʜᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴄᴏᴍᴍᴀɴᴅs:
 ...
 Usᴇʀ Cᴏᴍᴍᴀɴᴅs:
• /ғᴇᴅɪɴғᴏ : Iɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /ғᴇᴅᴀᴅᴍɪɴs : Lɪsᴛ ᴛʜᴇ ᴀᴅᴍɪɴs ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /ɪᴏɪɴғᴇᴅ : Jᴏɪɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ ᴛᴏ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ. A ᴄʜᴀᴛ ᴄᴀɴ ᴏɴʟʏ ɪᴏɪɴ ᴏɴᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ. Cʜᴀᴛ ᴏᴡɴᴇʀs ᴏɴʟʏ.
• /ʟᴇᴀᴠᴇғᴇᴅ: Lᴇᴀᴠᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ғᴇᴅᴇʀᴀᴛɪᴏɴ. Oɴʟʏ ᴄʜᴀᴛ ᴏᴡɴᴇʀs ᴄᴀɴ ᴅᴏ ᴛʜɪs.
• /ғᴇᴅsᴛᴀᴛ : Gɪᴠᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ʏᴏᴜʀ ʙᴀɴ ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /ғᴇᴅsᴛᴀᴛ <ᴜsᴇʀ ID> : Gɪᴠᴇs ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ᴜsᴇʀ's ʙᴀɴ ɪɴ ᴀ ғᴇᴅᴇʀᴀᴛɪᴏɴ.
• /ᴄʜᴀᴛғᴇᴅ: Iɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ғᴇᴅᴇʀᴀᴛɪᴏɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ ɪs ɪɴ.
