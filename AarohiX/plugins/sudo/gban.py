...
@app.on_message(filters.command(["botban", "globalbotban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["unbotgban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedbotusers", "gbanbotlist"]) & SUDOERS)
@language
